...
- [الخلفية (Background)](#الخلفية)
- [متطلبات تطبيقات البلوكتشين (Requirements for Blockchain Application)](#متطلبات-تطبيقات-البلوكتشين)
  * [دعم الملايين من المستخدمين (Support Millions of Users)](#دعم-الملايين-من-المستخدمين)
  * [الاستخدام المجاني (Free Usage)](#الاستخدام-المجاني)
  * [سهولة الترقيات ومعالجة الأخطاء (Easy upgrades and Bug Recovery)](#سهولة-في-الترقيات-ومعالجة-الأخطاء)
  * [التأخر المنخفض (Low Latency)](#التأخر-المنخفض)
  * [الأداء المتسلسل (Sequential Performance)](#الأداء-المتسلسل)
  * [الأداء والمعالجة المتوازية (Parallel Performance)](#المعالجة-المتوازية)
- [خوارزمية الإجماع \(BFT-DPOS\) (DPOS) (Consensus Algorithm)](#خوارزمية-الإجماع-bft-dpos)
  * [تأكيد المعاملة (Transaction Confirmation)](#تأكيد-المعاملة)
  * [إثبات الحصة بالمعاملة \(TaPoS\) (Transaction as Proof of Stake, TaPoS)](#إثبات-الحصة-بالمعاملة-tapos)
- [الحسابات (Accounts)](#الحسابات)
  * [الإجراءات والمناولة (Messages & Handlers)](#الإجراءات-والمناولة)
  * [إدارة الأذونات وفقًا للأدوار (Role Based Permission Management)](#إدارة-الأذونات-وفقًا-للأدوار)
    + [مستويات الأذونات المدرجة (Named Permission Levels)](#مستويات-الأذونات-المُدرجة)
    + [تخطيط الأذونات (Permission Mapping)](#تخطيط-الأذونات)
    + [تقييم الأذونات (Evaluating Permissions)](#تقييم-الأذونات)
      - [مجموعات الأذونات الافتراضية (Default Permission Groups)](#مجموعات-الأذونات-الافتراضية)
      - [التقييم الموازي للأذونات (Parallel Evaluation of Permissions)](#التقييم-الموازي-للأذونات)
  * [الإجراءات ذات التأخير الإلزامي (Actions with Mandatory Delay)](#الإجراءات-ذات-التأخير-الإلزامي)
  * [الاسترجاع من المفاتيح المسروقة (Recovery from Stolen Keys)](#الاسترجاع-للمفاتيح-المسروقة)
- [التنفيذ الحتمي المتوازي للتطبيقات (Deterministic Parallel Execution of Applications)](#التنفيذ-الحتمي-المتوازي-للتطبيقات-تقليل-تأخر-الاتصالات)
  * [تقليل تأخر الاتصالات (Minimizing Communication Latency)](#تقليل-تأخر-الاتصالات)
  * [مُناوِلات الإجراء ذات خاصية القراءة فقط (Read-Only Action Handlers)](#مُناوِلات-الإجراء-ذات-خاصية-القراءة-فقط)
  * [المعاملات الذرية مع حسابات متعددة (Atomic Transactions with Multiple Accounts)](#المعاملات-الذرية-مع-حسابات-متعددة)
  * [التقييم الجزئي لحالة البلوكتشين (Partial Evaluation of Blockchain State)](#التقييم-الجزئي-لحالة-البلوكتشين)
  * [الجدولة الذاتية وفقًا لأفضل جهد (Subjective Best Effort Scheduling)](#الجدولة-الذاتية-وفقًا-لأفضل-جهد)
  * [المعاملات المؤجلة (Deferred Transactions)](#المعاملات-المؤجلة)
  * [إجراءات حرة السياق (Context Free Actions)](#إجراءات-حرة-السياق)
- [نموذج الرمز واستخدام الموارد (Token Model and Resource Usage)](#tنموذج-الرمز-واستخدام-الموارد)
  * [القياسات الموضوعية والذاتية (Objective and Subjective Measurements)](#القياسات-الموضوعية-والشخصية)
  * [الدفع بواسطة المتلقي (Receiver Pays)](#الدفع-بواسطة-المتلقي)
  * [تفويض القدرات (Delegating Capacity)](#تفويض-الموارد)
  * [فصل تكاليف المعاملة عن قيمة الرمز (Separating Transaction costs from Token Value)](#فصل-تكاليف-المعاملة-عن-قيمة-الرمز)
  * [تكاليف تخزين الحالة (State Storage Costs)](#تكاليف-تخزين-الحالة)
  * [مكافئات الكتلة (Block Rewards)](#مكافئات-الكتلة)
  * [نظام اقتراح العمال (Worker Proposal System)](#نظام-اقتراح-العمال)
- [الحوكمة (Governance)](#الحوكمة)
  * [تجميد الحسابات (Freezing Accounts)](#تجميد-الحسابات)
  * [تغيير رمز الحساب (Changing Account Code)](#تغيير-رمز-الحساب)
  * [الدستور (Constitution)](#الدستور)
  * [ترقية البروتوكول والدستور (Upgrading the Protocol & Constitution)](#ترقية-البروتوكول-والدستور)
    + [التغييرات الطارئة (Emergency Changes)](#التغييرات-الطارئة)
- [المخطوطات والحواسيب الافتراضية (Scripts & Virtual Machines)](#المخطوطات-والحواسيب-الافتراضية)
  * [الإجراءات المُحددة بواسطة المخطط (Schema Defined Actions)](#الإجراءات-المُحددة-بواسطة-المخطط)
  * [قاعدة البيانات المُحددة بواسطة المخطط (Schema Defined Database)](#قاعدة-البيانات-المُحددة-بواسطة-المخطط)
  * [قاعدة بيانات عامة متعددة الفهرسة API (Generic Multi Index Database API)](#قاعدة-بيانات-عامة-متعددة-الفهرسة--api)
  * [فصل المصادقة عن التطبيق (Separating Authentication from Application)](#فصل-المصادقة-عن-التطبيق)
- [الاتصالات عبر البلوكتشين (Inter Blockchain Communication)](#الاتصالات-عبر-البلوكتشين)
  * [أدلة ميركل للتحقق الخفيف من العميل \(LCV\) (Merkle Proofs for Light Client Validation (LCV))](#أدلة-ميركل-للتحقق-الخفيف-من-العميل-lcv)
  * [تأخر الاتصالات عبر البلوكتشين (Latency of Interchain Communicatio)](#تأخر-الاتصالات-عبر-البلوكتشين)
  * [دليل الاكتمال (Proof of Completeness)](#دليل-الاكتمال)
  * [الشاهد المنفصل (Segregated Witness)](#دليل-الاكتمال)
- [الاستنتاج (Conclusion)](#الاستنتاج)
