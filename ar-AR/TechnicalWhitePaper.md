...
- [متطلبات تطبيقات البلوكتشين](#متطلبات-تطبيقات-البلوكتشين)
  * [دعم الملايين من المستخدمين](#دعم-الملايين-من-المستخدمين)
  * [الاستخدام المجاني](#الاستخدام-المجاني)
  * [سهولة الترقيات ومعالجة الأخطاء](#سهولة-في-الترقيات-ومعالجة-الأخطاء)
  * [التأخر المنخفض](#التأخر-المنخفض)
  * [الأداء المتسلسل](#الأداء-المتسلسل)
  * [الأداء والمعالجة المتوازية ](#المعالجة-المتوازية)
- [خوارزمية الإجماع \(BFT-DPOS\)](#خوارزمية-الإجماع-bft-dpos)
  * [تأكيد المعاملة](#تأكيد-المعاملة)
  * [إثبات الحصة بالمعاملة \(TaPoS\)](#إثبات-الحصة-بالمعاملة-tapos)
- [الحسابات](#الحسابات)
  * [الإجراءات والمناولة](#الإجراءات-والمناولة)
  * [إدارة الأذونات وفقًا للأدوار](#إدارة-الأذونات-وفقًا-للأدوار)
    + [مستويات الأذونات المدرجة](#مستويات-الأذونات-المُدرجة)
    + [تخطيط الأذونات](#تخطيط-الأذونات)
    + [تقييم الأذونات](#تقييم-الأذونات)
      - [مجموعات الأذونات الافتراضية](#مجموعات-الأذونات-الافتراضية)
      - [التقييم الموازي للأذونات](#التقييم-الموازي-للأذونات)
  * [الإجراءات ذات التأخير الإلزامي](#الإجراءات-ذات-التأخير-الإلزامي)
  * [الاسترجاع من المفاتيح المسروقة](#الاسترجاع-للمفاتيح-المسروقة)
- [التنفيذ الحتمي المتوازي للتطبيقات](#التنفيذ-الحتمي-المتوازي-للتطبيقات-تقليل-تأخر-الاتصالات)
  * [تقليل تأخر الاتصالات](#تقليل-تأخر-الاتصالات)
  * [مُناوِلات الإجراء ذات خاصية القراءة فقط](#مُناوِلات-الإجراء-ذات-خاصية-القراءة-فقط)
  * [المعاملات الذرية مع حسابات متعددة](#المعاملات-الذرية-مع-حسابات-متعددة)
  * [التقييم الجزئي لحالة البلوكتشين](#التقييم-الجزئي-لحالة-البلوكتشين)
  * [الجدولة الذاتية وفقًا لأفضل جهد](#الجدولة-الذاتية-وفقًا-لأفضل-جهد)
  * [المعاملات المؤجلة](#المعاملات-المؤجلة)
  * [إجراءات حرة السياق ](#إجراءات-حرة-السياق)
- [نموذج الرمز واستخدام الموارد](#tنموذج-الرمز-واستخدام-الموارد)
  * [القياسات الموضوعية والذاتية](#القياسات-الموضوعية-والشخصية)
  * [الدفع بواسطة المتلقي](#الدفع-بواسطة-المتلقي)
  * [تفويض القدرات](#تفويض-الموارد)
  * [فصل تكاليف المعاملة عن قيمة الرمز](#فصل-تكاليف-المعاملة-عن-قيمة-الرمز)
  * [تكاليف تخزين الحالة](#تكاليف-تخزين-الحالة)
  * [مكافئات الكتلة](#مكافئات-الكتلة)
  * [نظام اقتراح العمال](#نظام-اقتراح-العمال)
- [الحوكمة](#الحوكمة)
  * [تجميد الحسابات](#تجميد-الحسابات)
  * [تغيير رمز الحساب](#تغيير-رمز-الحساب)
  * [الدستور](#الدستور)
  * [ترقية البروتوكول والدستور](#ترقية-البروتوكول-والدستور)
    + [التغييرات الطارئة](#التغييرات-الطارئة)
- [المخطوطات والحواسيب الافتراضية](#المخطوطات-والحواسيب-الافتراضية)
  * [الإجراءات المُحددة بواسطة المخطط](#الإجراءات-المُحددة-بواسطة-المخطط)
  * [قاعدة البيانات المُحددة بواسطة المخطط](#قاعدة-البيانات-المُحددة-بواسطة-المخطط)
  * [قاعدة بيانات عامة متعددة الفهرسة API](#قاعدة-بيانات-عامة-متعددة-الفهرسة--api)
  * [فصل المصادقة عن التطبيق](#فصل-المصادقة-عن-التطبيق)
- [الاتصالات عبر البلوكتشين](#الاتصالات-عبر-البلوكتشين)
  * [أدلة ميركل للتحقق الخفيف من العميل \(LCV\)](#أدلة-ميركل-للتحقق-الخفيف-من-العميل-lcv)
  * [تأخر الاتصالات عبر البلوكتشين](#تأخر-الاتصالات-عبر-البلوكتشين)
  * [دليل الاكتمال](#دليل-الاكتمال)
  * [الشاهد المنفصل](#دليل-الاكتمال)
- [الاستنتاج](#الاستنتاج)
